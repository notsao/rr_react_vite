...
const MainContent = () => {
    return (
        <div className="text-black text-center flex justify-center align-center w-screen h-auto flex-col items-center font-family ">
            <img src={main_pic} class="aspect-auto h-3/4 tablet:py-0 px-5" />
...
//old pic class w=1/2 h-1/2 tablet:w-1/3 tablet:h-1/2 tablet:px-24